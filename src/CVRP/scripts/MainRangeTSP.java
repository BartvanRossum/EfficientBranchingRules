...
public class MainRangeTSP
{
	public static void main(String[] args) throws IloException, IOException
	{
		...
		for (int t = 0; t < T; t++)
		{
			...
			CVRPSolution newSolution = TSPSolver.run(instance, budget, alphaBudget, upperBound,
		...
		// Write logger.
		Writer.write(Logger.getLogger().getOutput(), "logger_CVRP_TSP_" + setting + ".csv");
	}
}
