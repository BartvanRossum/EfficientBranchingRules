...
public class IndexMinConstraint
		extends AbstractConstraint<CVRPInstance, CVRPColumn, CVRPPricingProblem>
{
	private final int vehicleIndex;

	public IndexMinConstraint(int vehicleIndex, int utility)
	{
		super(ConstraintType.GREATER, -utility);
	...
	public void addSlackVariable(AbstractMasterProblem<CVRPInstance, CVRPColumn, CVRPPricingProblem> masterProblem)
			throws IloException
	{
		masterProblem.addSlackVariable(this, 1, 1000 * 1000, 0, Double.MAX_VALUE);
	}
	...
	public boolean equals(Object obj)
	{
		...
		IndexMinConstraint other = (IndexMinConstraint) obj;
